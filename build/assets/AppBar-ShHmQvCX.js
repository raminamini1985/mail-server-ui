import{bw as oe,r as h,bu as re,j as e,d as t,I as l,T as r,o as T,cB as u,B as c,aS as te,dc as ae,aw as B,av as y,br as U,ag as _,bs as $,aq as ie,A as Y,s as v,al as M,dd as Q,de as ne,aD as le,ay as se,bc as V,az as J,aB as K,c9 as I,P as ce,cN as z,cM as me,c6 as pe,df as ue,ao as de,c3 as he,h as ge,d3 as k,aH as fe}from"./index-B-gixM8z.js";import{F as b}from"./FuseExample-aijpeiS7.js";import{D as be}from"./DocumentationPageBreadcrumb-BKkh75Pg.js";import{d as x}from"./Menu-DMDE8wck.js";import{A as f}from"./AppBar-tMbtq4_E.js";import{d as q}from"./AccountCircle-CnSulhTj.js";import{S as xe}from"./Switch-Cm7V2yLO.js";import{C as A}from"./Container-iL8RIvkd.js";import{d as C}from"./Search-G2fNona8.js";import{C as w}from"./CssBaseline-Dt1Zrezc.js";import{d as F}from"./Mail-_fj_XUbL.js";import{d as L}from"./MoreVert-DFaadvQc.js";import{d as ye}from"./Add-BM_qp5Y1.js";import{F as X}from"./Fab-C57bKnKa.js";import{L as ve}from"./ListItemAvatar-wsyRNjoX.js";import{d as Be}from"./KeyboardArrowUp-9fRKGHcy.js";import"./DocumentationNavigation-iJzugZsb.js";import"./ChangelogDoc-COHHXLg8.js";const we=["getTrigger","target"];function Ie(o,i){const{disableHysteresis:a=!1,threshold:n=100,target:m}=i,g=o.current;return m&&(o.current=m.pageYOffset!==void 0?m.pageYOffset:m.scrollTop),!a&&g!==void 0&&o.current<g?!1:o.current>n}const Me=typeof window<"u"?window:null;function R(o={}){const{getTrigger:i=Ie,target:a=Me}=o,n=oe(o,we),m=h.useRef(),[g,p]=h.useState(()=>i(m,n));return h.useEffect(()=>{const s=()=>{p(i(m,re({target:a},n)))};return s(),a.addEventListener("scroll",s,{passive:!0}),()=>{a.removeEventListener("scroll",s,{passive:!0})}},[a,i,JSON.stringify(n)]),g}function Te(){return e(c,{sx:{flexGrow:1},children:e(f,{position:"static",children:t(u,{children:[e(l,{size:"large",edge:"start",color:"inherit","aria-label":"menu",sx:{mr:2},children:e(x,{})}),e(r,{variant:"h6",component:"div",sx:{flexGrow:1},children:"News"}),e(T,{color:"inherit",children:"Login"})]})})})}const Ae=`import * as React from 'react';
