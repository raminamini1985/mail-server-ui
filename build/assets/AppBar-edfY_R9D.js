import{bY as oe,r as h,bV as re,j as e,N as f,d as t,z as l,T as r,C as T,O as u,H as c,bk as te,l as ae,dz as ie,b2 as B,b1 as y,c9 as U,aS as _,bZ as $,A as ne,B as Y,s as v,aV as M,I as Q,dA as le,D as se,g as ce,bJ as V,h as J,e as K,cO as I,d8 as Z,P as me,L as D,d9 as pe,cL as ue,dB as de,aY as he,cJ as ge,F as fe,dn as k,b8 as be}from"./index-hRi6i2cB.js";import{F as b}from"./FuseExample-QZXoGK-s.js";import{D as xe}from"./DocumentationPageBreadcrumb-BFsPEBAg.js";import{d as x}from"./Menu-DK2o5JCB.js";import{d as q}from"./AccountCircle-BJcKPfRU.js";import{C as A}from"./Container-CC2fetXn.js";import{d as C}from"./Search-sLWmwNbH.js";import{C as w}from"./CssBaseline-BPfhFiTN.js";import{d as F}from"./Mail-BMoURu8m.js";import{d as L}from"./MoreVert-B6WE0sN0.js";import{d as ye}from"./Add-Ce7rha7k.js";import{L as ve}from"./ListItemAvatar-DLxQpyJR.js";import{d as Be}from"./KeyboardArrowUp-DynA4y_O.js";import"./DocumentationNavigation-B9unmpAx.js";import"./ChangelogDoc-fv0_lxe2.js";const we=["getTrigger","target"];function Ie(o,i){const{disableHysteresis:a=!1,threshold:n=100,target:m}=i,g=o.current;return m&&(o.current=m.pageYOffset!==void 0?m.pageYOffset:m.scrollTop),!a&&g!==void 0&&o.current<g?!1:o.current>n}const Me=typeof window<"u"?window:null;function R(o={}){const{getTrigger:i=Ie,target:a=Me}=o,n=oe(o,we),m=h.useRef(),[g,p]=h.useState(()=>i(m,n));return h.useEffect(()=>{const s=()=>{p(i(m,re({target:a},n)))};return s(),a.addEventListener("scroll",s,{passive:!0}),()=>{a.removeEventListener("scroll",s,{passive:!0})}},[a,i,JSON.stringify(n)]),g}function Te(){return e(c,{sx:{flexGrow:1},children:e(f,{position:"static",children:t(u,{children:[e(l,{size:"large",edge:"start",color:"inherit","aria-label":"menu",sx:{mr:2},children:e(x,{})}),e(r,{variant:"h6",component:"div",sx:{flexGrow:1},children:"News"}),e(T,{color:"inherit",children:"Login"})]})})})}const Ae=`import * as React from 'react';
