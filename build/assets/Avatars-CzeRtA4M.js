import{d as e,j as a,B as t,cJ as s,dP as m,dQ as j,c9 as h,aS as f,bZ as A,dR as y,af as b,ad as d,s as x,cO as S,F as R,C as N,T as r,b8 as T}from"./index-DTYAWF45.js";import{F as o}from"./FuseExample-BpkyGcBB.js";import{D as B}from"./DocumentationPageBreadcrumb-D4ISDkzL.js";import{d as I}from"./Folder-Cv0s0ieh.js";import"./DocumentationNavigation-TV0mgQdh.js";import"./ChangelogDoc-CbVtVqTE.js";function C(){return e(s,{direction:"row",spacing:2,children:[a(t,{alt:"Remy Sharp",src:"/material-ui-static/images/avatar/1.jpg"}),a(t,{alt:"Travis Howard",src:"/material-ui-static/images/avatar/2.jpg"}),a(t,{alt:"Cindy Baker",src:"/material-ui-static/images/avatar/3.jpg"})]})}const H=`import * as React from 'react';
...
`;function O(i){let c=0,n;for(n=0;n<i.length;n+=1)c=i.charCodeAt(n)+((c<<5)-c);let g="#";for(n=0;n<3;n+=1){const w=c>>n*8&255;g+=`00${w.toString(16)}`.slice(-2)}return g}function l(i){return{sx:{bgcolor:O(i)},children:`${i.split(" ")[0][0]}${i.split(" ")[1][0]}`}}function $(){return e(s,{direction:"row",spacing:2,children:[a(t,{...l("Kent Dodds")}),a(t,{...l("Jed Watson")}),a(t,{...l("Tim Neutkens")})]})}const P=`import * as React from 'react';
import Avatar from '@mui/material/Avatar';
import Stack from '@mui/material/Stack';
...
`;function _(){return e(s,{direction:"row",spacing:2,children:[a(t,{alt:"Remy Sharp",src:"/material-ui-static/images/avatar/1.jpg",sx:{width:24,height:24}}),a(t,{alt:"Remy Sharp",src:"/material-ui-static/images/avatar/1.jpg"}),a(t,{alt:"Remy Sharp",src:"/material-ui-static/images/avatar/1.jpg",sx:{width:56,height:56}})]})}const F=`import * as React from 'react';
import Avatar from '@mui/material/Avatar';
import Stack from '@mui/material/Stack';
...
`;function Z(){return e(d,{max:4,children:[a(t,{alt:"Remy Sharp",src:"/material-ui-static/images/avatar/1.jpg"}),a(t,{alt:"Travis Howard",src:"/material-ui-static/images/avatar/2.jpg"}),a(t,{alt:"Cindy Baker",src:"/material-ui-static/images/avatar/3.jpg"}),a(t,{alt:"Agnes Walker",src:"/material-ui-static/images/avatar/4.jpg"}),a(t,{alt:"Trevor Henderson",src:"/material-ui-static/images/avatar/5.jpg"})]})}const X=`import * as React from 'react';
import Avatar from '@mui/material/Avatar';
