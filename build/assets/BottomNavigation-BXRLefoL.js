import{Z as F,$ as k,s as R,r as s,bv as T,bw as S,bu as g,bs as y,g as E,U as D,cb as O,br as $,ag as z,j as t,d as r,B as V,bc as H,A as U,az as W,aB as q,P as Q,h as G,o as J,T as n,aH as Y}from"./index-DRLfVU3l.js";import{F as w}from"./FuseExample-Cx3XkWxA.js";import{D as Z}from"./DocumentationPageBreadcrumb-Crdbj16m.js";import{d as I}from"./Favorite-BSpUpFig.js";import{d as P}from"./LocationOn-CGO8xO-G.js";import{d as K}from"./Folder-DTB6MaGY.js";import{d as X}from"./Archive-akehkG_F.js";import{C as tt}from"./CssBaseline-C9vTU-G6.js";import{L as et}from"./ListItemAvatar-DDLKO7Uo.js";import"./DocumentationNavigation-CLDPTxiN.js";import"./ChangelogDoc-CU400Rcv.js";function ot(e){return F("MuiBottomNavigation",e)}k("MuiBottomNavigation",["root"]);const at=["children","className","component","onChange","showLabels","value"],it=e=>{const{classes:o}=e;return D({root:["root"]},ot,o)},nt=R("div",{name:"MuiBottomNavigation",slot:"Root",overridesResolver:(e,o)=>o.root})(({theme:e})=>({display:"flex",justifyContent:"center",height:56,backgroundColor:(e.vars||e).palette.background.paper})),st=s.forwardRef(function(o,i){const a=T({props:o,name:"MuiBottomNavigation"}),{children:l,className:v,component:c="div",onChange:p,showLabels:d=!1,value:N}=a,x=S(a,at),h=g({},a,{component:c,showLabels:d}),f=it(h);return y.jsx(nt,g({as:c,className:E(f.root,v),ref:i,ownerState:h},x,{children:s.Children.map(l,(u,b)=>{if(!s.isValidElement(u))return null;const C=u.props.value===void 0?b:u.props.value;return s.cloneElement(u,{selected:C===N,showLabel:u.props.showLabel!==void 0?u.props.showLabel:d,value:C,onChange:p})})}))}),L=st;function rt(e){return F("MuiBottomNavigationAction",e)}const _=k("MuiBottomNavigationAction",["root","iconOnly","selected","label"]),mt=["className","icon","label","onChange","onClick","selected","showLabel","value"],lt=e=>{const{classes:o,showLabel:i,selected:a}=e;return D({root:["root",!i&&!a&&"iconOnly",a&&"selected"],label:["label",!i&&!a&&"iconOnly",a&&"selected"]},rt,o)},ct=R(O,{name:"MuiBottomNavigationAction",slot:"Root",overridesResolver:(e,o)=>{const{ownerState:i}=e;return[o.root,!i.showLabel&&!i.selected&&o.iconOnly]}})(({theme:e,ownerState:o})=>g({transition:e.transitions.create(["color","padding-top"],{duration:e.transitions.duration.short}),padding:"0px 12px",minWidth:80,maxWidth:168,color:(e.vars||e).palette.text.secondary,flexDirection:"column",flex:"1"},!o.showLabel&&!o.selected&&{paddingTop:14},!o.showLabel&&!o.selected&&!o.label&&{paddingTop:0},{[`&.${_.selected}`]:{color:(e.vars||e).palette.primary.main}})),ut=R("span",{name:"MuiBottomNavigationAction",slot:"Label",overridesResolver:(e,o)=>o.label})(({theme:e,ownerState:o})=>g({fontFamily:e.typography.fontFamily,fontSize:e.typography.pxToRem(12),opacity:1,transition:"font-size 0.2s, opacity 0.2s",transitionDelay:"0.1s"},!o.showLabel&&!o.selected&&{opacity:0,transitionDelay:"0s"},{[`&.${_.selected}`]:{fontSize:e.typography.pxToRem(14)}})),pt=s.forwardRef(function(o,i){const a=T({props:o,name:"MuiBottomNavigationAction"}),{className:l,icon:v,label:c,onChange:p,onClick:d,value:N}=a,x=S(a,mt),h=a,f=lt(h),u=b=>{p&&p(b,N),d&&d(b)};return y.jsxs(ct,g({ref:i,className:E(f.root,l),focusRipple:!0,onClick:u,ownerState:h},x,{children:[v,y.jsx(ut,{className:f.label,ownerState:h,children:c})]}))}),m=pt;var A={},dt=z;Object.defineProperty(A,"__esModule",{value:!0});var B=A.default=void 0,vt=dt($()),ht=y;B=A.default=(0,vt.default)((0,ht.jsx)("path",{d:"M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9m-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8z"}),"Restore");function gt(){const[e,o]=s.useState(0);return t(V,{sx:{width:500},children:r(L,{showLabels:!0,value:e,onChange:(i,a)=>{o(a)},children:[t(m,{label:"Recents",icon:t(B,{})}),t(m,{label:"Favorites",icon:t(I,{})}),t(m,{label:"Nearby",icon:t(P,{})})]})})}const ft=`import * as React from 'react';
...
`;function bt(){const[e,o]=s.useState("recents");return r(L,{sx:{width:500},value:e,onChange:(a,l)=>{o(l)},children:[t(m,{label:"Recents",value:"recents",icon:t(B,{})}),t(m,{label:"Favorites",value:"favorites",icon:t(I,{})}),t(m,{label:"Nearby",value:"nearby",icon:t(P,{})}),t(m,{label:"Folder",value:"folder",icon:t(K,{})})]})}const yt=`import * as React from 'react';
import BottomNavigation from '@mui/material/BottomNavigation';
import BottomNavigationAction from '@mui/material/BottomNavigationAction';
...
`;function M(){const e=o=>Math.floor(Math.random()*Math.floor(o));return Array.from(new Array(50)).map(()=>j[e(j.length)])}function Bt(){const[e,o]=s.useState(0),i=s.useRef(null),[a,l]=s.useState(()=>M());return s.useEffect(()=>{i.current.ownerDocument.body.scrollTop=0,l(M())},[e,l]),r(V,{sx:{pb:7},ref:i,children:[t(tt,{}),t(q,{children:a.map(({primary:v,secondary:c,person:p},d)=>r(H,{children:[t(et,{children:t(U,{alt:"Profile Picture",src:p})}),t(W,{primary:v,secondary:c})]},d+p))}),t(Q,{sx:{position:"fixed",bottom:0,left:0,right:0},elevation:3,children:r(L,{showLabels:!0,value:e,onChange:(v,c)=>{o(c)},children:[t(m,{label:"Recents",icon:t(B,{})}),t(m,{label:"Favorites",icon:t(I,{})}),t(m,{label:"Archive",icon:t(X,{})})]})})]})}const j=[{primary:"Brunch this week?",secondary:"I'll be in the neighbourhood this week. Let's grab a bite to eat",person:"/material-ui-static/images/avatar/5.jpg"},{primary:"Birthday Gift",secondary:`Do you have a suggestion for a good present for John on his work
