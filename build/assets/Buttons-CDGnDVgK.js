import{d as o,j as t,C as n,cJ as c,H as x,c9 as m,aS as d,bZ as u,z as r,s as l,dW as p,c1 as k,T as e,F as C,dn as h,b8 as N}from"./index-DTYAWF45.js";import{F as i}from"./FuseExample-BpkyGcBB.js";import{D as z}from"./DocumentationPageBreadcrumb-D4ISDkzL.js";import{d as s}from"./Delete-CkqIddMo.js";import{d as j}from"./Send-zs5hznSf.js";import"./DocumentationNavigation-TV0mgQdh.js";import"./ChangelogDoc-CbVtVqTE.js";function M(){return o(c,{spacing:2,direction:"row",children:[t(n,{variant:"text",children:"Text"}),t(n,{variant:"contained",children:"Contained"}),t(n,{variant:"outlined",children:"Outlined"})]})}const R=`import * as React from 'react';
...
`;var b={},Y=d;Object.defineProperty(b,"__esModule",{value:!0});var y=b.default=void 0,W=Y(m()),J=u;y=b.default=(0,W.default)((0,J.jsx)("path",{d:"m22 5.72-4.6-3.86-1.29 1.53 4.6 3.86zM7.88 3.39 6.6 1.86 2 5.71l1.29 1.53zM12.5 8H11v6l4.75 2.85.75-1.23-4-2.37zM12 4c-4.97 0-9 4.03-9 9s4.02 9 9 9c4.97 0 9-4.03 9-9s-4.03-9-9-9m0 16c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7"}),"Alarm");var B={},X=d;Object.defineProperty(B,"__esModule",{value:!0});var I=B.default=void 0,Z=X(m()),G=u;I=B.default=(0,Z.default)((0,G.jsx)("path",{d:"M11 9h2V6h3V4h-3V1h-2v3H8v2h3zm-4 9c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2m10 0c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2m-9.83-3.25.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.86-7.01L19.42 4h-.01l-1.1 2-2.76 5H8.53l-.13-.27L6.16 6l-.95-2-.94-2H1v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.13 0-.25-.11-.25-.25"}),"AddShoppingCart");function K(){return o(c,{direction:"row",spacing:1,children:[t(r,{"aria-label":"delete",children:t(s,{})}),t(r,{"aria-label":"delete",disabled:!0,color:"primary",children:t(s,{})}),t(r,{color:"secondary","aria-label":"add an alarm",children:t(y,{})}),t(r,{color:"primary","aria-label":"add to shopping cart",children:t(I,{})})]})}const Q=`import * as React from 'react';
...
`;var v={},ct=d;Object.defineProperty(v,"__esModule",{value:!0});var S=v.default=void 0,lt=ct(m()),st=u;S=v.default=(0,lt.default)((0,st.jsx)("path",{d:"M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96M14 13v4h-4v-4H7l5-5 5 5z"}),"CloudUpload");const mt=l("input")({clip:"rect(0 0 0 0)",clipPath:"inset(50%)",height:1,overflow:"hidden",position:"absolute",bottom:0,left:0,whiteSpace:"nowrap",width:1});function dt(){return o(n,{component:"label",variant:"contained",startIcon:t(S,{}),children:["Upload file",t(mt,{type:"file"})]})}const ut=`import * as React from 'react';
...
`,Bt=[{url:"/material-ui-static/images/buttons/breakfast.jpg",title:"Breakfast",width:"40%"},{url:"/material-ui-static/images/buttons/burgers.jpg",title:"Burgers",width:"30%"},{url:"/material-ui-static/images/buttons/camera.jpg",title:"Camera",width:"30%"}],gt=l(k)(({theme:a})=>({position:"relative",height:200,[a.breakpoints.down("sm")]:{width:"100% !important",height:100},"&:hover, &.Mui-focusVisible":{zIndex:1,"& .MuiImageBackdrop-root":{opacity:.15},"& .MuiImageMarked-root":{opacity:0},"& .MuiTypography-root":{border:"4px solid currentColor"}}})),vt=l("span")({position:"absolute",left:0,right:0,top:0,bottom:0,backgroundSize:"cover",backgroundPosition:"center 40%"}),xt=l("span")(({theme:a})=>({position:"absolute",left:0,right:0,top:0,bottom:0,display:"flex",alignItems:"center",justifyContent:"center",color:a.palette.common.white})),yt=l("span")(({theme:a})=>({position:"absolute",left:0,right:0,top:0,bottom:0,backgroundColor:a.palette.common.black,opacity:.4,transition:a.transitions.create("opacity")})),It=l("span")(({theme:a})=>({height:3,width:18,backgroundColor:a.palette.common.white,position:"absolute",bottom:-2,left:"calc(50% - 9px)",transition:a.transitions.create("opacity")}));function St(){return t(x,{sx:{display:"flex",flexWrap:"wrap",minWidth:300,width:"100%"},children:Bt.map(a=>o(gt,{focusRipple:!0,style:{width:a.width},children:[t(vt,{style:{backgroundImage:`url(${a.url})`}}),t(yt,{className:"MuiImageBackdrop-root"}),t(xt,{children:o(e,{component:"span",variant:"subtitle1",color:"inherit",sx:{position:"relative",p:4,pt:2,pb:w=>`calc(${w.spacing(1)} + 6px)`},children:[a.title,t(It,{className:"MuiImageMarked-root"})]})})]},a.title))})}const wt=`import * as React from 'react';
import { styled } from '@mui/material/styles';
import Box from '@mui/material/Box';
...
`}),o(e,{className:"text-14 mb-32",component:"div",children:["This has the advantage of supporting any element, for instance, a link ",t("code",{children:"<a>"})," element."]})]})}export{Dt as default};
