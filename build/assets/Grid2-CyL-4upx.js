...
`,z=u(h)(({theme:n})=>({backgroundColor:n.palette.mode==="dark"?"#1A2027":"#fff",...n.typography.body2,padding:n.spacing(1),textAlign:"center",color:n.palette.text.secondary}));function fn(){return e(c,{sx:{width:"100%"},children:t(o,{container:!0,rowSpacing:1,columnSpacing:{xs:1,sm:2,md:3},children:[e(o,{xs:6,children:e(z,{children:"1"})}),e(o,{xs:6,children:e(z,{children:"2"})}),e(o,{xs:6,children:e(z,{children:"3"})}),e(o,{xs:6,children:e(z,{children:"4"})})]})})}const xn=`import * as React from 'react';
import { styled } from '@mui/material/styles';
import Grid from '@mui/material/Unstable_Grid2';
import Paper from '@mui/material/Paper';
import Box from '@mui/material/Box';
...
`,F=u(h)(({theme:n})=>({backgroundColor:n.palette.mode==="dark"?"#1A2027":"#fff",...n.typography.body2,padding:n.spacing(1),textAlign:"center",color:n.palette.text.secondary}));function Rn(){return t(o,{container:!0,spacing:3,sx:{flexGrow:1},children:[e(o,{xs:6,xsOffset:3,md:2,mdOffset:0,children:e(F,{children:"1"})}),e(o,{xs:4,md:2,mdOffset:"auto",children:e(F,{children:"2"})}),e(o,{xs:4,xsOffset:4,md:2,mdOffset:0,children:e(F,{children:"3"})}),e(o,{xs:!0,md:6,mdOffset:2,children:e(F,{children:"4"})})]})}const jn=`import * as React from 'react';
import { styled } from '@mui/material/styles';
import Paper from '@mui/material/Paper';
import Grid from '@mui/material/Unstable_Grid2';
...
`;function Tn(){return e(c,{sx:{flexGrow:1,p:2},children:e(o,{container:!0,spacing:2,sx:{"--Grid-borderWidth":"1px",borderTop:"var(--Grid-borderWidth) solid",borderLeft:"var(--Grid-borderWidth) solid",borderColor:"divider","& > div":{borderRight:"var(--Grid-borderWidth) solid",borderBottom:"var(--Grid-borderWidth) solid",borderColor:"divider"}},children:[...Array(6)].map((n,i)=>e(o,{xs:12,sm:6,md:4,lg:3,minHeight:160},i))})})}const Ln=`import * as React from 'react';
import Box from '@mui/material/Box';
import Grid from '@mui/material/Unstable_Grid2';
