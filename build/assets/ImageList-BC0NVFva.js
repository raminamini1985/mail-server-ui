import{az as T,aA as j,s as H,bV as c,r as f,bX as z,bY as M,bZ as b,x as _,au as R,j as t,H as v,c9 as F,aS as P,d as i,L as K,z as k,F as W,C as q,T as a,b8 as Q}from"./index-hRi6i2cB.js";import{F as l}from"./FuseExample-QZXoGK-s.js";import{D as Y}from"./DocumentationPageBreadcrumb-BFsPEBAg.js";import{b as E,I as m,a as u}from"./ImageListItemBar-D6ts1jrq.js";import{d as A}from"./StarBorder-BpxiY4bx.js";import"./DocumentationNavigation-B9unmpAx.js";import"./ChangelogDoc-fv0_lxe2.js";function U(e){return T("MuiImageList",e)}j("MuiImageList",["root","masonry","quilted","standard","woven"]);const V=["children","className","cols","component","rowHeight","gap","style","variant"],Z=e=>{const{classes:s,variant:o}=e;return R({root:["root",o]},U,s)},J=H("ul",{name:"MuiImageList",slot:"Root",overridesResolver:(e,s)=>{const{ownerState:o}=e;return[s.root,s[o.variant]]}})(({ownerState:e})=>c({display:"grid",overflowY:"auto",listStyle:"none",padding:0,WebkitOverflowScrolling:"touch"},e.variant==="masonry"&&{display:"block"})),O=f.forwardRef(function(s,o){const n=z({props:s,name:"MuiImageList"}),{children:g,className:C,cols:w=2,component:L="ul",rowHeight:d="auto",gap:r=4,style:x,variant:p="standard"}=n,$=M(n,V),D=f.useMemo(()=>({rowHeight:d,gap:r,variant:p}),[d,r,p]);f.useEffect(()=>{},[]);const N=p==="masonry"?c({columnCount:w,columnGap:r},x):c({gridTemplateColumns:`repeat(${w}, 1fr)`,gap:r},x),B=c({},n,{component:L,gap:r,rowHeight:d,variant:p}),y=Z(B);return b.jsx(J,c({as:L,className:_(y.root,y[p],C),ref:o,style:N,ownerState:B},$,{children:b.jsx(E.Provider,{value:D,children:g})}))}),h=O;function G(){return t(h,{sx:{width:500,height:450},cols:3,rowHeight:164,children:X.map(e=>t(m,{children:t("img",{srcSet:`${e.img}?w=164&h=164&fit=crop&auto=format&dpr=2 2x`,src:`${e.img}?w=164&h=164&fit=crop&auto=format`,alt:e.title,loading:"lazy"})},e.img))})}const X=[{img:"https://images.unsplash.com/photo-1551963831-b3b1ca40c98e",title:"Breakfast"},{img:"https://images.unsplash.com/photo-1551782450-a2132b4ba21d",title:"Burger"},{img:"https://images.unsplash.com/photo-1522770179533-24471fcdba45",title:"Camera"},{img:"https://images.unsplash.com/photo-1444418776041-9c7e33cc5a9c",title:"Coffee"},{img:"https://images.unsplash.com/photo-1533827432537-70133748f5c8",title:"Hats"},{img:"https://images.unsplash.com/photo-1558642452-9d2a7deb7f62",title:"Honey"},{img:"https://images.unsplash.com/photo-1516802273409-68526ee1bdd6",title:"Basketball"},{img:"https://images.unsplash.com/photo-1518756131217-31eb79b20e8f",title:"Fern"},{img:"https://images.unsplash.com/photo-1597645587822-e99fa5d45d25",title:"Mushrooms"},{img:"https://images.unsplash.com/photo-1567306301408-9b74779a11af",title:"Tomato basil"},{img:"https://images.unsplash.com/photo-1471357674240-e1a485acb3e1",title:"Sea star"},{img:"https://images.unsplash.com/photo-1589118949245-7d38baf380d6",title:"Bike"}],tt=`import * as React from 'react';
