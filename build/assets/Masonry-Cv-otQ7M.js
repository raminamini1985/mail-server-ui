...
`,Ze=[150,30,90,70,90,100,150,30,50,80],Ke=p(y)(({theme:e})=>({backgroundColor:e.palette.mode==="dark"?"#1A2027":"#fff",...e.typography.body2,padding:e.spacing(.5),textAlign:"center",color:e.palette.text.secondary}));function Qe(){return n(x,{sx:{width:500,minHeight:377},children:n(b,{columns:3,spacing:3,children:Ze.map((e,t)=>n(Ke,{sx:{height:e},children:t+1},t))})})}const Xe=`import * as React from 'react';
import Box from '@mui/material/Box';
import { styled } from '@mui/material/styles';
import Paper from '@mui/material/Paper';
import Masonry from '@mui/lab/Masonry';
