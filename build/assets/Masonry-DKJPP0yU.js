import{az as ae,aA as se,s as p,r as H,bX as ie,bY as re,bV as C,aK as me,aM as ce,bZ as q,x as le,au as de,dM as G,e3 as pe,al as T,dN as j,bn as he,e4 as E,P as y,j as n,H as x,d as i,cQ as ue,cR as ge,T as o,cS as fe,F as ye,C as xe,b8 as be}from"./index-DTYAWF45.js";import{F as g}from"./FuseExample-BpkyGcBB.js";import{D as Me}from"./DocumentationPageBreadcrumb-D4ISDkzL.js";import{d as ke}from"./ExpandMore-CreQrCc6.js";import"./DocumentationNavigation-TV0mgQdh.js";import"./ChangelogDoc-CbVtVqTE.js";function we(e){return ae("MuiMasonry",e)}se("MuiMasonry",["root"]);const Ce=["children","className","component","columns","spacing","defaultColumns","defaultHeight","defaultSpacing"],f=e=>Number(e.replace("px","")),Be={flexBasis:"100%",width:0,margin:0,padding:0},Ne=e=>{const{classes:t}=e;return de({root:["root"]},we,t)},ve=({ownerState:e,theme:t})=>{let m={width:"100%",display:"flex",flexFlow:"column wrap",alignContent:"flex-start",boxSizing:"border-box","& > *":{boxSizing:"border-box"}};const h={};if(e.isSSR){const s={},a=f(t.spacing(e.defaultSpacing));for(let r=1;r<=e.defaultColumns;r+=1)s[`&:nth-of-type(${e.defaultColumns}n+${r%e.defaultColumns})`]={order:r};return h.height=e.defaultHeight,h.margin=-(a/2),h["& > *"]=C({},m["& > *"],s,{margin:a/2,width:`calc(${(100/e.defaultColumns).toFixed(2)}% - ${a}px)`}),C({},m,h)}const c=G({values:e.spacing,breakpoints:t.breakpoints.values}),B=pe(t);m=T(m,j({theme:t},c,s=>{let a;if(typeof s=="string"&&!Number.isNaN(Number(s))||typeof s=="number"){const r=Number(s);a=E(B,r)}else a=s;return C({margin:`calc(0px - (${a} / 2))`,"& > *":{margin:`calc(${a} / 2)`}},e.maxColumnHeight&&{height:typeof a=="number"?Math.ceil(e.maxColumnHeight+f(a)):`calc(${e.maxColumnHeight}px + ${a})`})}));const l=G({values:e.columns,breakpoints:t.breakpoints.values});return m=T(m,j({theme:t},l,s=>{const r=`${(100/Number(s)).toFixed(2)}%`,N=typeof c=="string"&&!Number.isNaN(Number(c))||typeof c=="number"?E(B,Number(c)):"0px";return{"& > *":{width:`calc(${r} - ${N})`}}})),typeof c=="object"&&(m=T(m,j({theme:t},c,(s,a)=>{if(a){const r=Number(s),N=Object.keys(l).pop(),u=E(B,r);return{"& > *":{width:`calc(${`${(100/(typeof l=="object"?l[a]||l[N]:l)).toFixed(2)}%`} - ${u})`}}}return null}))),m},Re=p("div",{name:"MuiMasonry",slot:"Root",overridesResolver:(e,t)=>[t.root]})(ve),Se=H.forwardRef(function(t,m){const h=ie({props:t,name:"MuiMasonry"}),{children:c,className:B,component:L="div",columns:l=4,spacing:P=1,defaultColumns:s,defaultHeight:a,defaultSpacing:r}=h,N=re(h,Ce),u=H.useRef(),[$,z]=H.useState(),V=!$&&a&&s!==void 0&&r!==void 0,[K,Q]=H.useState(V?s-1:0),D=C({},h,{spacing:P,columns:l,maxColumnHeight:$,defaultColumns:s,defaultHeight:a,defaultSpacing:r,isSSR:V}),X=Ne(D),Y=M=>{if(!u.current||!M||M.length===0)return;const d=u.current,R=u.current.firstChild,O=d.clientWidth,W=R.clientWidth;if(O===0||W===0)return;const _=window.getComputedStyle(R),ee=f(_.marginLeft),ne=f(_.marginRight),F=Math.round(O/(W+ee+ne)),S=new Array(F).fill(0);let v=!1;d.childNodes.forEach(k=>{if(k.nodeType!==Node.ELEMENT_NODE||k.dataset.class==="line-break"||v)return;const A=window.getComputedStyle(k),te=f(A.marginTop),oe=f(A.marginBottom),U=f(A.height)?Math.ceil(f(A.height))+te+oe:0;if(U===0){v=!0;return}for(let w=0;w<k.childNodes.length;w+=1){const I=k.childNodes[w];if(I.tagName==="IMG"&&I.clientHeight===0){v=!0;break}}if(!v){const w=S.indexOf(Math.min(...S));S[w]+=U;const I=w+1;k.style.order=I}}),v||he.flushSync(()=>{z(Math.max(...S)),Q(F>0?F-1:0)})};me(()=>{if(typeof ResizeObserver>"u")return;let M;const d=new ResizeObserver(()=>{M=requestAnimationFrame(Y)});return u.current&&u.current.childNodes.forEach(R=>{d.observe(R)}),()=>{M&&window.cancelAnimationFrame(M),d&&d.disconnect()}},[l,P,c]);const Z=ce(m,u),J=new Array(K).fill("").map((M,d)=>q.jsx("span",{"data-class":"line-break",style:C({},Be,{order:d+1})},d));return q.jsxs(Re,C({as:L,className:le(X.root,B),ref:Z,ownerState:D},N,{children:[c,J]}))}),b=Se,Ae=[150,30,90,70,110,150,130,80,50,90,100,150,30,50,80],Ie=p(y)(({theme:e})=>({backgroundColor:e.palette.mode==="dark"?"#1A2027":"#fff",...e.typography.body2,padding:e.spacing(.5),textAlign:"center",color:e.palette.text.secondary}));function He(){return n(x,{sx:{width:500,minHeight:393},children:n(b,{columns:4,spacing:2,children:Ae.map((e,t)=>n(Ie,{sx:{height:e},children:t+1},t))})})}const Pe=`import * as React from 'react';
...
`,Qe=[150,30,90,70,90,100,150,30,50,80],Xe=p(y)(({theme:e})=>({backgroundColor:e.palette.mode==="dark"?"#1A2027":"#fff",...e.typography.body2,padding:e.spacing(.5),textAlign:"center",color:e.palette.text.secondary}));function Ye(){return n(x,{sx:{width:500,minHeight:377},children:n(b,{columns:3,spacing:3,children:Qe.map((e,t)=>n(Xe,{sx:{height:e},children:t+1},t))})})}const Ze=`import * as React from 'react';
import Box from '@mui/material/Box';
import { styled } from '@mui/material/styles';
import Paper from '@mui/material/Paper';
import Masonry from '@mui/lab/Masonry';
