import{d as e,j as n,cJ as r,c9 as f,aS as P,bZ as b,r as d,T as t,s as y,F as R,C as S,dn as N,b8 as k}from"./index-DTYAWF45.js";import{F as o}from"./FuseExample-BpkyGcBB.js";import{D as C}from"./DocumentationPageBreadcrumb-D4ISDkzL.js";import{P as a,a as T,u as I}from"./Pagination-Cyxydv9t.js";import{T as B}from"./TablePagination-kdqzvbHr.js";import"./DocumentationNavigation-TV0mgQdh.js";import"./ChangelogDoc-CbVtVqTE.js";import"./LastPage-P_XItt8U.js";import"./TableCell-DRiZ-1Sl.js";function j(){return e(r,{spacing:2,children:[n(a,{count:10}),n(a,{count:10,color:"primary"}),n(a,{count:10,color:"secondary"}),n(a,{count:10,disabled:!0})]})}const z=`import * as React from 'react';
...
`;function A(){return e(r,{spacing:2,children:[n(a,{count:10,variant:"outlined"}),n(a,{count:10,variant:"outlined",color:"primary"}),n(a,{count:10,variant:"outlined",color:"secondary"}),n(a,{count:10,variant:"outlined",disabled:!0})]})}const F=`import * as React from 'react';
import Pagination from '@mui/material/Pagination';
import Stack from '@mui/material/Stack';
...
`;function L(){return e(r,{spacing:2,children:[n(a,{count:10,shape:"rounded"}),n(a,{count:10,variant:"outlined",shape:"rounded"})]})}const _=`import * as React from 'react';
import Pagination from '@mui/material/Pagination';
import Stack from '@mui/material/Stack';
...
`;function O(){return e(r,{spacing:2,children:[n(a,{count:10,showFirstButton:!0,showLastButton:!0}),n(a,{count:10,hidePrevButton:!0,hideNextButton:!0})]})}const H=`import * as React from 'react';
import Pagination from '@mui/material/Pagination';
import Stack from '@mui/material/Stack';
...
`;function X(){return e(r,{spacing:2,children:[n(a,{count:11,defaultPage:6,siblingCount:0}),n(a,{count:11,defaultPage:6})," ",n(a,{count:11,defaultPage:6,siblingCount:0,boundaryCount:2}),n(a,{count:11,defaultPage:6,boundaryCount:2})]})}const Z=`import * as React from 'react';
import Pagination from '@mui/material/Pagination';
import Stack from '@mui/material/Stack';
...
`;function G(){const[i,m]=d.useState(1);return e(r,{spacing:2,children:[e(t,{children:["Page: ",i]}),n(a,{count:10,page:i,onChange:(u,l)=>{m(l)}})]})}const Q=`import * as React from 'react';
...
`,V=y("ul")({listStyle:"none",padding:0,margin:0,display:"flex"});function nn(){const{items:i}=I({count:10});return n("nav",{children:n(V,{children:i.map(({page:m,type:c,selected:u,...l},h)=>{let s=null;return c==="start-ellipsis"||c==="end-ellipsis"?s="…":c==="page"?s=n("button",{type:"button",style:{fontWeight:u?"bold":void 0},...l,children:m}):s=n("button",{type:"button",...l,children:c}),n("li",{children:s},h)})})})}const tn=`import * as React from 'react';
...
`;function an(){const[i,m]=d.useState(2),[c,u]=d.useState(10);return n(B,{component:"div",count:100,page:i,onPageChange:(s,w)=>{m(w)},rowsPerPage:c,onRowsPerPageChange:s=>{u(parseInt(s.target.value,10)),m(0)}})}const en=`import * as React from 'react';
