import{d as n,j as e,P as r,B as p,s as m,de as h,ao as g,c3 as u,h as x,o as v,T as t,d2 as c,aH as y}from"./index-DaquC3HQ.js";import{F as o}from"./FuseExample-aWT15uaH.js";import{D as b}from"./DocumentationPageBreadcrumb-Cp8rQom_.js";import{G as s}from"./Grid-QBH5mSUX.js";import"./DocumentationNavigation-GRGcrCKi.js";import"./ChangelogDoc-ngbKmtJS.js";function P(){return n(p,{sx:{display:"flex",flexWrap:"wrap","& > :not(style)":{m:1,width:128,height:128}},children:[e(r,{elevation:0}),e(r,{}),e(r,{elevation:3})]})}const w=`import * as React from 'react';
...
`,N=m(r)(({theme:a})=>({...a.typography.body2,textAlign:"center",color:a.palette.text.secondary,height:60,lineHeight:"60px"})),k=h({palette:{mode:"dark"}}),T=h({palette:{mode:"light"}});function S(){return e(s,{container:!0,spacing:2,children:[T,k].map((a,f)=>e(s,{item:!0,xs:6,children:e(g,{theme:a,children:e(p,{sx:{p:2,borderRadius:2,bgcolor:"background.default",display:"grid",gridTemplateColumns:{md:"1fr 1fr"},gap:2},children:[0,1,2,3,4,6,8,12,16,24].map(i=>e(N,{elevation:i,children:`elevation=${i}`},i))})})},f))})}const D=`import * as React from 'react';
...
`,l=m(r)(({theme:a})=>({width:120,height:120,padding:a.spacing(2),...a.typography.body2,textAlign:"center"}));function B(){return n(u,{direction:"row",spacing:2,children:[e(l,{variant:"elevation",children:"default variant"}),e(l,{variant:"outlined",children:"outlined variant"})]})}const q=`import * as React from 'react';
...
`,d=m(r)(({theme:a})=>({width:120,height:120,padding:a.spacing(2),...a.typography.body2,textAlign:"center"}));function j(){return n(u,{direction:"row",spacing:2,children:[e(d,{square:!1,children:"rounded corners"}),e(d,{square:!0,children:"square corners"})]})}const C=`import * as React from 'react';
import Stack from '@mui/material/Stack';
import Paper from '@mui/material/Paper';
import { styled } from '@mui/material/styles';
