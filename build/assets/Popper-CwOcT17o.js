import{r as m,d as o,j as e,B as g,dl as b,c6 as P,P as y,T as t,o as d,h as x,aH as E}from"./index-DaquC3HQ.js";import{F as f}from"./FuseExample-aWT15uaH.js";import{D as T}from"./DocumentationPageBreadcrumb-Cp8rQom_.js";import{u as C,a as B}from"./react-spring_web.modern-1Z-qj-k_.js";import{G as h}from"./Grid-QBH5mSUX.js";import{d as k,e as R,P as S}from"./index-Df1aslTi.js";import"./DocumentationNavigation-GRGcrCKi.js";import"./ChangelogDoc-ngbKmtJS.js";function w(){const[r,p]=m.useState(null),i=u=>{p(r?null:u.currentTarget)},s=!!r,c=s?"simple-popper":void 0;return o("div",{children:[e("button",{"aria-describedby":c,type:"button",onClick:i,children:"Toggle Popper"}),e(b,{id:c,open:s,anchorEl:r,children:e(g,{sx:{border:1,p:1,bgcolor:"background.paper"},children:"The content of the Popper."})})]})}const N=`import * as React from 'react';
...
`;function M(){const[r,p]=m.useState(null),[i,s]=m.useState(!1),[c,u]=m.useState(),n=a=>l=>{p(l.currentTarget),s(v=>c!==a||!v),u(a)};return o(g,{sx:{width:500},children:[e(b,{sx:{zIndex:1200},open:i,anchorEl:r,placement:c,transition:!0,children:({TransitionProps:a})=>e(P,{...a,timeout:350,children:e(y,{children:e(t,{sx:{p:2},children:"The content of the Popper."})})})}),e(h,{container:!0,justifyContent:"center",children:o(h,{item:!0,children:[e(d,{onClick:n("top-start"),children:"top-start"}),e(d,{onClick:n("top"),children:"top"}),e(d,{onClick:n("top-end"),children:"top-end"})]})}),o(h,{container:!0,justifyContent:"center",children:[o(h,{item:!0,xs:6,children:[e(d,{onClick:n("left-start"),children:"left-start"}),e("br",{}),e(d,{onClick:n("left"),children:"left"}),e("br",{}),e(d,{onClick:n("left-end"),children:"left-end"})]}),o(h,{item:!0,container:!0,xs:6,alignItems:"flex-end",direction:"column",children:[e(h,{item:!0,children:e(d,{onClick:n("right-start"),children:"right-start"})}),e(h,{item:!0,children:e(d,{onClick:n("right"),children:"right"})}),e(h,{item:!0,children:e(d,{onClick:n("right-end"),children:"right-end"})})]})]}),e(h,{container:!0,justifyContent:"center",children:o(h,{item:!0,children:[e(d,{onClick:n("bottom-start"),children:"bottom-start"}),e(d,{onClick:n("bottom"),children:"bottom"}),e(d,{onClick:n("bottom-end"),children:"bottom-end"})]})})]})}const I=`import * as React from 'react';
import Box from '@mui/material/Box';
...
`;function H(){return e(S,{variant:"popper",popupId:"demo-popup-popper",children:r=>o("div",{children:[e(d,{variant:"contained",...k(r),children:"Toggle Popper"}),e(b,{...R(r),transition:!0,children:({TransitionProps:p})=>e(P,{...p,timeout:350,children:e(y,{children:e(t,{sx:{p:2},children:"The content of the Popper."})})})})]})})}const D=`import * as React from 'react';
import Typography from '@mui/material/Typography';
import Button from '@mui/material/Button';
import Popper from '@mui/material/Popper';
