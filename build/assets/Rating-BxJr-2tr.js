...
`,Kt={.5:"Useless",1:"Useless+",1.5:"Poor",2:"Poor+",2.5:"Ok",3:"Ok+",3.5:"Good",4:"Good+",4.5:"Excellent",5:"Excellent+"};function Qt(){return r(B,{sx:{width:200,display:"flex",alignItems:"center"},children:[e(c,{name:"text-feedback",value:3.5,readOnly:!0,precision:.5,emptyIcon:e(Ce,{style:{opacity:.55},fontSize:"inherit"})}),e(B,{sx:{ml:2},children:Kt[3.5]})]})}const Zt=`import * as React from 'react';
import Box from '@mui/material/Box';
import Rating from '@mui/material/Rating';
import StarIcon from '@mui/icons-material/Star';
