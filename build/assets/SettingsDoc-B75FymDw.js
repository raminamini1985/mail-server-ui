import{d as t,j as e,T as n,d3 as o,aH as a}from"./index-Dboj72Vj.js";const i=`import themesConfig from 'app/configs/themesConfig';
...
`;function l(){return t(a,{children:[e(n,{variant:"h4",className:"mb-40 font-700",children:"Default Settings"}),t(n,{className:"mb-16",component:"p",children:["To set the default layout and theme settings for your app, navigate to the file:",e("code",{children:"app/configs/settingsConfig.ts"})]}),e(o,{component:"pre",className:"language-jsx",children:i})]})}export{l as default};
