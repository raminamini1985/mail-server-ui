import{d as a,j as e,c3 as y,B as r,T as t,A as d,I as w,r as v,aP as x,aQ as k,s as b,h as S,o as A,d2 as c,aH as C}from"./index-DaquC3HQ.js";import{F as s}from"./FuseExample-aWT15uaH.js";import{D as B}from"./DocumentationPageBreadcrumb-Cp8rQom_.js";import{S as o}from"./Skeleton-BhChiU0u.js";import{G as m}from"./Grid-QBH5mSUX.js";import{d as T}from"./MoreVert-bbxp4BRE.js";import{C as N}from"./CardHeader-DoXJL-hC.js";import{C as I}from"./CardMedia-DUU1V2oA.js";import"./DocumentationNavigation-GRGcrCKi.js";import"./ChangelogDoc-ngbKmtJS.js";function D(){return a(y,{spacing:1,children:[e(o,{variant:"text",sx:{fontSize:"1rem"}}),e(o,{variant:"circular",width:40,height:40}),e(o,{variant:"rectangular",width:210,height:60}),e(o,{variant:"rounded",width:210,height:60})]})}const F=`import * as React from 'react';
...
`;function M(){return a(r,{sx:{width:300},children:[e(o,{}),e(o,{animation:"wave"}),e(o,{animation:!1})]})}const j=`import * as React from 'react';
...
`,E=["h1","h3","body1","caption"];function g(l){const{loading:i=!1}=l;return e("div",{children:E.map(n=>e(t,{component:"div",variant:n,children:i?e(o,{}):n},n))})}function _(){return a(m,{container:!0,spacing:8,children:[e(m,{item:!0,xs:!0,children:e(g,{loading:!0})}),e(m,{item:!0,xs:!0,children:e(g,{})})]})}const X=`import * as React from 'react';
...
`,H=b("img")({width:"100%"});function u(l){const{loading:i=!1}=l;return a("div",{children:[a(r,{sx:{display:"flex",alignItems:"center"},children:[e(r,{sx:{margin:1},children:i?e(o,{variant:"circular",children:e(d,{})}):e(d,{src:"https://pbs.twimg.com/profile_images/877631054525472768/Xp5FAPD5_reasonably_small.jpg"})}),e(r,{sx:{width:"100%"},children:i?e(o,{width:"100%",children:e(t,{children:"."})}):e(t,{children:"Ted"})})]}),i?e(o,{variant:"rectangular",width:"100%",children:e("div",{style:{paddingTop:"57%"}})}):e(H,{src:"https://pi.tedcdn.com/r/talkstar-photos.s3.amazonaws.com/uploads/72bda89f-9bbf-4685-910a-2f151c4f3a8a/NicolaSturgeon_2019T-embed.jpg?w=512",alt:""})]})}function V(){return a(m,{container:!0,spacing:8,children:[e(m,{item:!0,xs:!0,children:e(u,{loading:!0})}),e(m,{item:!0,xs:!0,children:e(u,{})})]})}const z=`import * as React from 'react';
