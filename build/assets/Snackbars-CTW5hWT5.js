import{r as m,d as a,j as e,o,dU as h,I as y,B as C,dV as b,c3 as I,c5 as B,cM as N,c7 as T,bn as R,cB as A,T as t,dW as F,d1 as z,h as O,d3 as S,aH as G}from"./index-DRLfVU3l.js";import{F as d}from"./FuseExample-Cx3XkWxA.js";import{D}from"./DocumentationPageBreadcrumb-Crdbj16m.js";import{d as w}from"./Close-D8Wnx6gL.js";import{G as k}from"./Grid-D0A_RoSF.js";import{A as P}from"./Alert-vA84NHPQ.js";import{d as M}from"./Menu-DCxw2txM.js";import{d as E}from"./Add-DDyTD85n.js";import{C as j}from"./CssBaseline-C9vTU-G6.js";import{A as U}from"./AppBar-B1koUJXD.js";import{F as H}from"./Fab-BM3phWqK.js";import"./DocumentationNavigation-CLDPTxiN.js";import"./ChangelogDoc-CU400Rcv.js";function L(){const[n,i]=m.useState(!1),r=()=>{i(!0)},s=(l,p)=>{p!=="clickaway"&&i(!1)},c=a(m.Fragment,{children:[e(o,{color:"secondary",size:"small",onClick:s,children:"UNDO"}),e(y,{size:"small","aria-label":"close",color:"inherit",onClick:s,children:e(w,{fontSize:"small"})})]});return a("div",{children:[e(o,{onClick:r,children:"Open Snackbar"}),e(h,{open:n,autoHideDuration:6e3,onClose:s,message:"Note archived",action:c})]})}const V=`import * as React from 'react';
...
`;function ee(){const[n,i]=m.useState(!1),r=()=>{i(!0)},s=(c,l)=>{l!=="clickaway"&&i(!1)};return a("div",{children:[e(o,{onClick:r,children:"Open Snackbar"}),e(h,{open:n,autoHideDuration:6e3,onClose:s,children:e(P,{onClose:s,severity:"success",variant:"filled",sx:{width:"100%"},children:"This is a success Alert inside a Snackbar!"})})]})}const te=`import * as React from 'react';
import Button from '@mui/material/Button';
import Snackbar from '@mui/material/Snackbar';
...
`;function ne(){return a(m.Fragment,{children:[e(j,{}),e(R,{styles:n=>({body:{backgroundColor:n.palette.background.paper}})}),a("div",{children:[e(U,{position:"static",color:"primary",children:a(A,{children:[e(y,{edge:"start",sx:{mr:2},color:"inherit","aria-label":"menu",children:e(M,{})}),e(t,{variant:"h6",color:"inherit",component:"div",children:"App bar"})]})}),e(H,{color:"secondary",sx:{position:"absolute",bottom:n=>n.spacing(2),right:n=>n.spacing(2)},children:e(E,{})}),e(h,{open:!0,autoHideDuration:6e3,message:"Archived",action:e(o,{color:"inherit",size:"small",children:"Undo"}),sx:{bottom:{xs:90,sm:0}}})]})]})}const ae=`import * as React from 'react';
...
`;function se(){const{enqueueSnackbar:n}=z(),i=()=>{n("I love snacks.")},r=s=>()=>{n("This is a success message!",{variant:s})};return a(m.Fragment,{children:[e(o,{onClick:i,children:"Show snackbar"}),e(o,{onClick:r("success"),children:"Show success snackbar"})]})}function re(){return e(F,{maxSnack:3,children:e(se,{})})}const ce=`import * as React from 'react';
import Button from '@mui/material/Button';
