import{r as m,d as a,j as e,C as o,eh as h,z as y,H as C,ei as b,cJ as I,cL as B,d9 as N,cN as T,cK as R,c8 as A,O as F,T as t,N as z,d8 as O,ej as G,Y as D,F as P,dn as S,b8 as E}from"./index-DTYAWF45.js";import{F as d}from"./FuseExample-BpkyGcBB.js";import{D as M}from"./DocumentationPageBreadcrumb-D4ISDkzL.js";import{d as w}from"./Close-DLf70IZ5.js";import{G as k}from"./Grid-BS8Ulast.js";import{d as j}from"./Menu-Dlm8yJGA.js";import{d as H}from"./Add-CXjNaM_u.js";import{C as U}from"./CssBaseline-CC1VQ_aQ.js";import"./DocumentationNavigation-TV0mgQdh.js";import"./ChangelogDoc-CbVtVqTE.js";function L(){const[n,i]=m.useState(!1),r=()=>{i(!0)},s=(l,u)=>{u!=="clickaway"&&i(!1)},c=a(m.Fragment,{children:[e(o,{color:"secondary",size:"small",onClick:s,children:"UNDO"}),e(y,{size:"small","aria-label":"close",color:"inherit",onClick:s,children:e(w,{fontSize:"small"})})]});return a("div",{children:[e(o,{onClick:r,children:"Open Snackbar"}),e(h,{open:n,autoHideDuration:6e3,onClose:s,message:"Note archived",action:c})]})}const q=`import * as React from 'react';
...
`;function Y(){const[n,i]=m.useState(!1);return a("div",{children:[e(o,{onClick:()=>{i(!0)},children:"Open Snackbar"}),e(h,{open:n,autoHideDuration:5e3,onClose:(c,l)=>{l!=="clickaway"&&i(!1)},message:"This Snackbar will be dismissed in 5 seconds."})]})}const $=`import * as React from 'react';
import Button from '@mui/material/Button';
import Snackbar from '@mui/material/Snackbar';
...
`;function ne(){return a(m.Fragment,{children:[e(U,{}),e(A,{styles:n=>({body:{backgroundColor:n.palette.background.paper}})}),a("div",{children:[e(z,{position:"static",color:"primary",children:a(F,{children:[e(y,{edge:"start",sx:{mr:2},color:"inherit","aria-label":"menu",children:e(j,{})}),e(t,{variant:"h6",color:"inherit",component:"div",children:"App bar"})]})}),e(O,{color:"secondary",sx:{position:"absolute",bottom:n=>n.spacing(2),right:n=>n.spacing(2)},children:e(H,{})}),e(h,{open:!0,autoHideDuration:6e3,message:"Archived",action:e(o,{color:"inherit",size:"small",children:"Undo"}),sx:{bottom:{xs:90,sm:0}}})]})]})}const ae=`import * as React from 'react';
...
`;function se(){const{enqueueSnackbar:n}=D(),i=()=>{n("I love snacks.")},r=s=>()=>{n("This is a success message!",{variant:s})};return a(m.Fragment,{children:[e(o,{onClick:i,children:"Show snackbar"}),e(o,{onClick:r("success"),children:"Show success snackbar"})]})}function re(){return e(G,{maxSnack:3,children:e(se,{})})}const ce=`import * as React from 'react';
import Button from '@mui/material/Button';
