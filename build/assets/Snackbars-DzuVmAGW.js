import{r as m,d as a,j as e,o,dU as h,I as y,B as C,dV as b,c3 as I,c6 as B,cM as N,c8 as T,c5 as R,bn as A,cB as F,T as t,cC as z,dW as O,d1 as G,h as D,d3 as S,aH as P}from"./index-Dboj72Vj.js";import{F as d}from"./FuseExample-N6iJ4cUl.js";import{D as M}from"./DocumentationPageBreadcrumb-Bvg7cG0G.js";import{d as w}from"./Close-cu38bP-X.js";import{G as k}from"./Grid-Bme3TTBm.js";import{d as E}from"./Menu-Qr5xBpzu.js";import{d as j}from"./Add-D4TgAlCR.js";import{C as U}from"./CssBaseline-Xh4cB0Rf.js";import{F as H}from"./Fab-CkVUD1CV.js";import"./DocumentationNavigation-C6guAWXi.js";import"./ChangelogDoc-IB80xpHv.js";function L(){const[n,i]=m.useState(!1),r=()=>{i(!0)},s=(l,p)=>{p!=="clickaway"&&i(!1)},c=a(m.Fragment,{children:[e(o,{color:"secondary",size:"small",onClick:s,children:"UNDO"}),e(y,{size:"small","aria-label":"close",color:"inherit",onClick:s,children:e(w,{fontSize:"small"})})]});return a("div",{children:[e(o,{onClick:r,children:"Open Snackbar"}),e(h,{open:n,autoHideDuration:6e3,onClose:s,message:"Note archived",action:c})]})}const V=`import * as React from 'react';
...
`;function ne(){return a(m.Fragment,{children:[e(U,{}),e(A,{styles:n=>({body:{backgroundColor:n.palette.background.paper}})}),a("div",{children:[e(z,{position:"static",color:"primary",children:a(F,{children:[e(y,{edge:"start",sx:{mr:2},color:"inherit","aria-label":"menu",children:e(E,{})}),e(t,{variant:"h6",color:"inherit",component:"div",children:"App bar"})]})}),e(H,{color:"secondary",sx:{position:"absolute",bottom:n=>n.spacing(2),right:n=>n.spacing(2)},children:e(j,{})}),e(h,{open:!0,autoHideDuration:6e3,message:"Archived",action:e(o,{color:"inherit",size:"small",children:"Undo"}),sx:{bottom:{xs:90,sm:0}}})]})]})}const ae=`import * as React from 'react';
...
`;function se(){const{enqueueSnackbar:n}=G(),i=()=>{n("I love snacks.")},r=s=>()=>{n("This is a success message!",{variant:s})};return a(m.Fragment,{children:[e(o,{onClick:i,children:"Show snackbar"}),e(o,{onClick:r("success"),children:"Show success snackbar"})]})}function re(){return e(O,{maxSnack:3,children:e(se,{})})}const ce=`import * as React from 'react';
import Button from '@mui/material/Button';
