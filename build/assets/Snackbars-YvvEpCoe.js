import{r as m,d as a,j as e,o,dU as h,I as y,B as C,dV as b,c3 as I,c6 as B,cM as N,c8 as T,c5 as R,bn as A,cB as F,T as t,dW as z,d1 as O,h as G,d3 as S,aH as D}from"./index-B-gixM8z.js";import{F as d}from"./FuseExample-aijpeiS7.js";import{D as P}from"./DocumentationPageBreadcrumb-BKkh75Pg.js";import{d as w}from"./Close-VD6_AuUb.js";import{G as k}from"./Grid-DKL5d1br.js";import{d as M}from"./Menu-DMDE8wck.js";import{d as E}from"./Add-BM_qp5Y1.js";import{C as j}from"./CssBaseline-Dt1Zrezc.js";import{A as U}from"./AppBar-tMbtq4_E.js";import{F as H}from"./Fab-C57bKnKa.js";import"./DocumentationNavigation-iJzugZsb.js";import"./ChangelogDoc-COHHXLg8.js";function L(){const[n,i]=m.useState(!1),r=()=>{i(!0)},s=(l,p)=>{p!=="clickaway"&&i(!1)},c=a(m.Fragment,{children:[e(o,{color:"secondary",size:"small",onClick:s,children:"UNDO"}),e(y,{size:"small","aria-label":"close",color:"inherit",onClick:s,children:e(w,{fontSize:"small"})})]});return a("div",{children:[e(o,{onClick:r,children:"Open Snackbar"}),e(h,{open:n,autoHideDuration:6e3,onClose:s,message:"Note archived",action:c})]})}const V=`import * as React from 'react';
...
`;function ne(){return a(m.Fragment,{children:[e(j,{}),e(A,{styles:n=>({body:{backgroundColor:n.palette.background.paper}})}),a("div",{children:[e(U,{position:"static",color:"primary",children:a(F,{children:[e(y,{edge:"start",sx:{mr:2},color:"inherit","aria-label":"menu",children:e(M,{})}),e(t,{variant:"h6",color:"inherit",component:"div",children:"App bar"})]})}),e(H,{color:"secondary",sx:{position:"absolute",bottom:n=>n.spacing(2),right:n=>n.spacing(2)},children:e(E,{})}),e(h,{open:!0,autoHideDuration:6e3,message:"Archived",action:e(o,{color:"inherit",size:"small",children:"Undo"}),sx:{bottom:{xs:90,sm:0}}})]})]})}const ae=`import * as React from 'react';
