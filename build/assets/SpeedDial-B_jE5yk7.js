import{$ as pe,Z as de,s as y,S as ie,bu as s,r as l,bv as me,aj as Ae,bw as G,a8 as $e,ab as Be,bs as u,g as z,a2 as Me,U as ue,G as ke,dx as Ee,aq as je,ca as _e,br as xe,ag as ve,j as e,B as A,d as p,aS as j,aE as He,aF as Ge,dA as ze,c6 as oe,dv as Ue,h as Ze,o as Ke,T as r,aH as Ve}from"./index-DRLfVU3l.js";import{F as _}from"./FuseExample-Cx3XkWxA.js";import{D as qe}from"./DocumentationPageBreadcrumb-Crdbj16m.js";import{d as U}from"./Save-BOVLzIaI.js";import{d as Z}from"./Share-ERYFm49H.js";import{F as ge}from"./Fab-BM3phWqK.js";import{Z as We}from"./Zoom-DV6hBVOf.js";import{S as Ye}from"./Switch-DBXvBUMU.js";import{d as Je}from"./Edit-Cbgwvo2S.js";import"./DocumentationNavigation-CLDPTxiN.js";import"./ChangelogDoc-CU400Rcv.js";function Qe(o){return de("MuiSpeedDial",o)}const Xe=pe("MuiSpeedDial",["root","fab","directionUp","directionDown","directionLeft","directionRight","actions","actionsClosed"]),ne=Xe,eo=["ref"],oo=["ariaLabel","FabProps","children","className","direction","hidden","icon","onBlur","onClose","onFocus","onKeyDown","onMouseEnter","onMouseLeave","onOpen","open","openIcon","TransitionComponent","transitionDuration","TransitionProps"],no=["ref"],to=o=>{const{classes:n,open:t,direction:a}=o,c={root:["root",`direction${ie(a)}`],fab:["fab"],actions:["actions",!t&&"actionsClosed"]};return ue(c,Qe,n)};function H(o){if(o==="up"||o==="down")return"vertical";if(o==="right"||o==="left")return"horizontal"}const C=32,te=16,io=y("div",{name:"MuiSpeedDial",slot:"Root",overridesResolver:(o,n)=>{const{ownerState:t}=o;return[n.root,n[`direction${ie(t.direction)}`]]}})(({theme:o,ownerState:n})=>s({zIndex:(o.vars||o).zIndex.speedDial,display:"flex",alignItems:"center",pointerEvents:"none"},n.direction==="up"&&{flexDirection:"column-reverse",[`& .${ne.actions}`]:{flexDirection:"column-reverse",marginBottom:-C,paddingBottom:te+C}},n.direction==="down"&&{flexDirection:"column",[`& .${ne.actions}`]:{flexDirection:"column",marginTop:-C,paddingTop:te+C}},n.direction==="left"&&{flexDirection:"row-reverse",[`& .${ne.actions}`]:{flexDirection:"row-reverse",marginRight:-C,paddingRight:te+C}},n.direction==="right"&&{flexDirection:"row",[`& .${ne.actions}`]:{flexDirection:"row",marginLeft:-C,paddingLeft:te+C}})),ao=y(ge,{name:"MuiSpeedDial",slot:"Fab",overridesResolver:(o,n)=>n.fab})(()=>({pointerEvents:"auto"})),ro=y("div",{name:"MuiSpeedDial",slot:"Actions",overridesResolver:(o,n)=>{const{ownerState:t}=o;return[n.actions,!t.open&&n.actionsClosed]}})(({ownerState:o})=>s({display:"flex",pointerEvents:"auto"},!o.open&&{transition:"top 0s linear 0.2s",pointerEvents:"none"})),lo=l.forwardRef(function(n,t){const a=me({props:n,name:"MuiSpeedDial"}),c=Ae(),I={enter:c.transitions.duration.enteringScreen,exit:c.transitions.duration.leavingScreen},{ariaLabel:d,FabProps:{ref:M}={},children:S,className:D,direction:v="up",hidden:g=!1,icon:b,onBlur:k,onClose:f,onFocus:T,onKeyDown:O,onMouseEnter:E,onMouseLeave:w,onOpen:F,open:ae,TransitionComponent:W=We,transitionDuration:Y=I,TransitionProps:ye}=a,J=G(a.FabProps,eo),Ie=G(a,oo),[h,L]=$e({controlled:ae,default:!1,name:"SpeedDial",state:"open"}),Q=s({},a,{open:h,direction:v}),X=to(Q),N=l.useRef();l.useEffect(()=>()=>{clearTimeout(N.current)},[]);const re=l.useRef(0),le=l.useRef(),P=l.useRef([]);P.current=[P.current[0]];const Te=l.useCallback(i=>{P.current[0]=i},[]),Pe=Be(M,Te),Re=(i,m)=>x=>{P.current[i+1]=x,m&&m(x)},Oe=i=>{O&&O(i);const m=i.key.replace("Arrow","").toLowerCase(),{current:x=m}=le;if(i.key==="Escape"){L(!1),P.current[0].focus(),f&&f(i,"escapeKeyDown");return}if(H(m)===H(x)&&H(m)!==void 0){i.preventDefault();const se=m===x?1:-1,ee=ke(re.current+se,0,P.current.length-1);P.current[ee].focus(),re.current=ee,le.current=x}};l.useEffect(()=>{h||(re.current=0,le.current=void 0)},[h]);const Se=i=>{i.type==="mouseleave"&&w&&w(i),i.type==="blur"&&k&&k(i),clearTimeout(N.current),i.type==="blur"?N.current=setTimeout(()=>{L(!1),f&&f(i,"blur")}):(L(!1),f&&f(i,"mouseLeave"))},we=i=>{J.onClick&&J.onClick(i),clearTimeout(N.current),h?(L(!1),f&&f(i,"toggle")):(L(!0),F&&F(i,"toggle"))},De=i=>{i.type==="mouseenter"&&E&&E(i),i.type==="focus"&&T&&T(i),clearTimeout(N.current),h||(N.current=setTimeout(()=>{L(!0),F&&F(i,{focus:"focus",mouseenter:"mouseEnter"}[i.type])}))},ce=d.replace(/^[^a-z]+|[^\w:.-]+/gi,""),be=l.Children.toArray(S).filter(i=>l.isValidElement(i)),Fe=be.map((i,m)=>{const x=i.props,{FabProps:{ref:se}={},tooltipPlacement:ee}=x,Le=G(x.FabProps,no),Ne=ee||(H(v)==="vertical"?"left":"top");return l.cloneElement(i,{FabProps:s({},Le,{ref:Re(m,se)}),delay:30*(h?m:be.length-m),open:h,tooltipPlacement:Ne,id:`${ce}-action-${m}`})});return u.jsxs(io,s({className:z(X.root,D),ref:t,role:"presentation",onKeyDown:Oe,onBlur:Se,onFocus:De,onMouseEnter:De,onMouseLeave:Se,ownerState:Q},Ie,{children:[u.jsx(W,s({in:!g,timeout:Y,unmountOnExit:!0},ye,{children:u.jsx(ao,s({color:"primary","aria-label":d,"aria-haspopup":"true","aria-expanded":h,"aria-controls":`${ce}-actions`},J,{onClick:we,className:z(X.fab,J.className),ref:Pe,ownerState:Q,children:l.isValidElement(b)&&Me(b,["SpeedDialIcon"])?l.cloneElement(b,{open:h}):b}))})),u.jsx(ro,{id:`${ce}-actions`,role:"menu","aria-orientation":H(v),className:z(X.actions,!h&&X.actionsClosed),ownerState:Q,children:Fe})]}))}),K=lo;function co(o){return de("MuiSpeedDialAction",o)}const so=pe("MuiSpeedDialAction",["fab","fabClosed","staticTooltip","staticTooltipClosed","staticTooltipLabel","tooltipPlacementLeft","tooltipPlacementRight"]),po=so,mo=["className","delay","FabProps","icon","id","open","TooltipClasses","tooltipOpen","tooltipPlacement","tooltipTitle"],uo=o=>{const{open:n,tooltipPlacement:t,classes:a}=o,c={fab:["fab",!n&&"fabClosed"],staticTooltip:["staticTooltip",`tooltipPlacement${ie(t)}`,!n&&"staticTooltipClosed"],staticTooltipLabel:["staticTooltipLabel"]};return ue(c,co,a)},fo=y(ge,{name:"MuiSpeedDialAction",slot:"Fab",skipVariantsResolver:!1,overridesResolver:(o,n)=>{const{ownerState:t}=o;return[n.fab,!t.open&&n.fabClosed]}})(({theme:o,ownerState:n})=>s({margin:8,color:(o.vars||o).palette.text.secondary,backgroundColor:(o.vars||o).palette.background.paper,"&:hover":{backgroundColor:o.vars?o.vars.palette.SpeedDialAction.fabHoverBg:Ee(o.palette.background.paper,.15)},transition:`${o.transitions.create("transform",{duration:o.transitions.duration.shorter})}, opacity 0.8s`,opacity:1},!n.open&&{opacity:0,transform:"scale(0)"})),ho=y("span",{name:"MuiSpeedDialAction",slot:"StaticTooltip",overridesResolver:(o,n)=>{const{ownerState:t}=o;return[n.staticTooltip,!t.open&&n.staticTooltipClosed,n[`tooltipPlacement${ie(t.tooltipPlacement)}`]]}})(({theme:o,ownerState:n})=>({position:"relative",display:"flex",alignItems:"center",[`& .${po.staticTooltipLabel}`]:s({transition:o.transitions.create(["transform","opacity"],{duration:o.transitions.duration.shorter}),opacity:1},!n.open&&{opacity:0,transform:"scale(0.5)"},n.tooltipPlacement==="left"&&{transformOrigin:"100% 50%",right:"100%",marginRight:8},n.tooltipPlacement==="right"&&{transformOrigin:"0% 50%",left:"100%",marginLeft:8})})),So=y("span",{name:"MuiSpeedDialAction",slot:"StaticTooltipLabel",overridesResolver:(o,n)=>n.staticTooltipLabel})(({theme:o})=>s({position:"absolute"},o.typography.body1,{backgroundColor:(o.vars||o).palette.background.paper,borderRadius:(o.vars||o).shape.borderRadius,boxShadow:(o.vars||o).shadows[1],color:(o.vars||o).palette.text.secondary,padding:"4px 16px",wordBreak:"keep-all"})),Do=l.forwardRef(function(n,t){const a=me({props:n,name:"MuiSpeedDialAction"}),{className:c,delay:I=0,FabProps:d={},icon:M,id:S,open:D,TooltipClasses:v,tooltipOpen:g=!1,tooltipPlacement:b="left",tooltipTitle:k}=a,f=G(a,mo),T=s({},a,{tooltipPlacement:b}),O=uo(T),[E,w]=l.useState(g),F=()=>{w(!1)},ae=()=>{w(!0)},W={transitionDelay:`${I}ms`},Y=u.jsx(fo,s({size:"small",className:z(O.fab,c),tabIndex:-1,role:"menuitem",ownerState:T},d,{style:s({},W,d.style),children:M}));return g?u.jsxs(ho,s({id:S,ref:t,className:O.staticTooltip,ownerState:T},f,{children:[u.jsx(So,{style:W,id:`${S}-label`,className:O.staticTooltipLabel,ownerState:T,children:k}),l.cloneElement(Y,{"aria-labelledby":`${S}-label`})]})):(!D&&E&&w(!1),u.jsx(je,s({id:S,ref:t,title:k,placement:b,onClose:F,onOpen:ae,open:D&&E,classes:v},f,{children:Y})))}),V=Do,bo=_e(u.jsx("path",{d:"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"}),"Add");function xo(o){return de("MuiSpeedDialIcon",o)}const vo=pe("MuiSpeedDialIcon",["root","icon","iconOpen","iconWithOpenIconOpen","openIcon","openIconOpen"]),R=vo,go=["className","icon","open","openIcon"],Co=o=>{const{classes:n,open:t,openIcon:a}=o;return ue({root:["root"],icon:["icon",t&&"iconOpen",a&&t&&"iconWithOpenIconOpen"],openIcon:["openIcon",t&&"openIconOpen"]},xo,n)},yo=y("span",{name:"MuiSpeedDialIcon",slot:"Root",overridesResolver:(o,n)=>{const{ownerState:t}=o;return[{[`& .${R.icon}`]:n.icon},{[`& .${R.icon}`]:t.open&&n.iconOpen},{[`& .${R.icon}`]:t.open&&t.openIcon&&n.iconWithOpenIconOpen},{[`& .${R.openIcon}`]:n.openIcon},{[`& .${R.openIcon}`]:t.open&&n.openIconOpen},n.root]}})(({theme:o,ownerState:n})=>({height:24,[`& .${R.icon}`]:s({transition:o.transitions.create(["transform","opacity"],{duration:o.transitions.duration.short})},n.open&&s({transform:"rotate(45deg)"},n.openIcon&&{opacity:0})),[`& .${R.openIcon}`]:s({position:"absolute",transition:o.transitions.create(["transform","opacity"],{duration:o.transitions.duration.short}),opacity:0,transform:"rotate(-45deg)"},n.open&&{transform:"rotate(0deg)",opacity:1})})),Ce=l.forwardRef(function(n,t){const a=me({props:n,name:"MuiSpeedDialIcon"}),{className:c,icon:I,openIcon:d}=a,M=G(a,go),S=a,D=Co(S);function v(g,b){return l.isValidElement(g)?l.cloneElement(g,{className:b}):g}return u.jsxs(yo,s({className:z(D.root,c),ref:t,ownerState:S},M,{children:[d?v(d,D.openIcon):null,I?v(I,D.icon):u.jsx(bo,{className:D.icon})]}))});Ce.muiName="SpeedDialIcon";const q=Ce;var fe={},Io=ve;Object.defineProperty(fe,"__esModule",{value:!0});var $=fe.default=void 0,To=Io(xe()),Po=u;$=fe.default=(0,To.default)((0,Po.jsx)("path",{d:"M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12zm-1 4H8c-1.1 0-1.99.9-1.99 2L6 21c0 1.1.89 2 1.99 2H19c1.1 0 2-.9 2-2V11zM8 21V7h6v5h5v9z"}),"FileCopyOutlined");var he={},Ro=ve;Object.defineProperty(he,"__esModule",{value:!0});var B=he.default=void 0,Oo=Ro(xe()),wo=u;B=he.default=(0,Oo.default)((0,wo.jsx)("path",{d:"M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3m-3 11H8v-5h8zm3-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1m-1-9H6v4h12z"}),"Print");const Fo=[{icon:e($,{}),name:"Copy"},{icon:e(U,{}),name:"Save"},{icon:e(B,{}),name:"Print"},{icon:e(Z,{}),name:"Share"}];function Lo(){return e(A,{sx:{height:320,transform:"translateZ(0px)",flexGrow:1},children:e(K,{ariaLabel:"SpeedDial basic example",sx:{position:"absolute",bottom:16,right:16},icon:e(q,{}),children:Fo.map(o=>e(V,{icon:o.icon,tooltipTitle:o.name},o.name))})})}const No=`import * as React from 'react';
...
`,zo=[{icon:e($,{}),name:"Copy"},{icon:e(U,{}),name:"Save"},{icon:e(B,{}),name:"Print"},{icon:e(Z,{}),name:"Share"}];function Uo(){const[o,n]=l.useState(!1),t=()=>n(!0),a=()=>n(!1);return p(A,{sx:{height:330,transform:"translateZ(0px)",flexGrow:1},children:[e(Ue,{open:o}),e(K,{ariaLabel:"SpeedDial tooltip example",sx:{position:"absolute",bottom:16,right:16},icon:e(q,{}),onClose:a,onOpen:t,open:o,children:zo.map(c=>e(V,{icon:c.icon,tooltipTitle:c.name,tooltipOpen:!0,onClick:a},c.name))})]})}const Zo=`import * as React from 'react';
import Box from '@mui/material/Box';
