import{s as d,P as l,j as e,d as o,cJ as c,H as C,D as B,r as h,b5 as u,b6 as g,dX as f,bk as r,cM as i,B as N,T as t,F as W,C as D,dn as m,b8 as $}from"./index-DTYAWF45.js";import{F as s}from"./FuseExample-BpkyGcBB.js";import{D as H}from"./DocumentationPageBreadcrumb-D4ISDkzL.js";import{H as z}from"./HighlightedCode-BtPakF1Q.js";import{G as p}from"./Grid-BS8Ulast.js";import"./DocumentationNavigation-TV0mgQdh.js";import"./ChangelogDoc-CbVtVqTE.js";const y=d(l)(({theme:a})=>({backgroundColor:a.palette.mode==="dark"?"#1A2027":"#fff",...a.typography.body2,padding:a.spacing(1),textAlign:"center",color:a.palette.text.secondary}));function M(){return e(C,{sx:{width:"100%"},children:o(c,{spacing:2,children:[e(y,{children:"Item 1"}),e(y,{children:"Item 2"}),e(y,{children:"Item 3"})]})})}const E=`import * as React from 'react';
...
`,k=d(l)(({theme:a})=>({backgroundColor:a.palette.mode==="dark"?"#1A2027":"#fff",...a.typography.body2,padding:a.spacing(1),textAlign:"center",color:a.palette.text.secondary}));function J(){return e("div",{children:o(c,{direction:"row",spacing:2,children:[e(k,{children:"Item 1"}),e(k,{children:"Item 2"}),e(k,{children:"Item 3"})]})})}const U=`import * as React from 'react';
import Paper from '@mui/material/Paper';
import Stack from '@mui/material/Stack';
import { styled } from '@mui/material/styles';
...
`,S=d(l)(({theme:a})=>({backgroundColor:a.palette.mode==="dark"?"#1A2027":"#fff",...a.typography.body2,padding:a.spacing(1),textAlign:"center",color:a.palette.text.secondary}));function Y(){return e("div",{children:o(c,{direction:"row",divider:e(B,{orientation:"vertical",flexItem:!0}),spacing:2,children:[e(S,{children:"Item 1"}),e(S,{children:"Item 2"}),e(S,{children:"Item 3"})]})})}const Z=`import * as React from 'react';
...
`,I=d(l)(({theme:a})=>({backgroundColor:a.palette.mode==="dark"?"#1A2027":"#fff",...a.typography.body2,padding:a.spacing(1),textAlign:"center",color:a.palette.text.secondary}));function X(){return e("div",{children:o(c,{direction:{xs:"column",sm:"row"},spacing:{xs:1,sm:2,md:4},children:[e(I,{children:"Item 1"}),e(I,{children:"Item 2"}),e(I,{children:"Item 3"})]})})}const _=`import * as React from 'react';
import Paper from '@mui/material/Paper';
import Stack from '@mui/material/Stack';
import { styled } from '@mui/material/styles';
...
`,w=d(l)(({theme:a})=>({backgroundColor:a.palette.mode==="dark"?"#1A2027":"#fff",...a.typography.body2,padding:a.spacing(1),textAlign:"center",color:a.palette.text.secondary,flexGrow:1}));function q(){return e(C,{sx:{width:200},children:o(c,{spacing:{xs:1,sm:2},direction:"row",useFlexGap:!0,flexWrap:"wrap",children:[e(w,{children:"Item 1"}),e(w,{children:"Item 2"}),e(w,{children:"Long content"})]})})}const K=`import * as React from 'react';
import Paper from '@mui/material/Paper';
import Stack from '@mui/material/Stack';
import Box from '@mui/material/Box';
import { styled } from '@mui/material/styles';
...
`;function O(){const[a,G]=h.useState("row"),[x,A]=h.useState("center"),[b,j]=h.useState("center"),[v,L]=h.useState(2),P=`
<Stack
  direction="${a}"
  justifyContent="${x}"
  alignItems="${b}"
...
`,F=d(l)(({theme:a})=>({backgroundColor:a.palette.mode==="dark"?"#1A2027":"#fff",...a.typography.body2,padding:a.spacing(1),textAlign:"center",color:a.palette.text.secondary,maxWidth:400})),R=`Truncation should be conditionally applicable on this long line of text
 as this is a much longer line than what the container can support.`;function V(){return o(C,{sx:{flexGrow:1,overflow:"hidden",px:3},children:[e(F,{sx:{my:1,mx:"auto",p:2},children:o(c,{spacing:2,direction:"row",alignItems:"center",children:[e(N,{children:"W"}),e(t,{noWrap:!0,children:R})]})}),e(F,{sx:{my:1,mx:"auto",p:2},children:o(c,{spacing:2,direction:"row",alignItems:"center",children:[e(c,{children:e(N,{children:"W"})}),e(c,{sx:{minWidth:0},children:e(t,{noWrap:!0,children:R})})]})})]})}const ee=`import * as React from 'react';
