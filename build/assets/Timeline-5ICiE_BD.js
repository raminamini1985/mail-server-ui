import{s as L,T as n,bu as x,r as g,bv as $,bw as z,bs as u,g as B,U as H,d as i,j as e,br as f,ag as C,h as P,o as F,aH as q}from"./index-DaquC3HQ.js";import{F as a}from"./FuseExample-aWT15uaH.js";import{D as U}from"./DocumentationPageBreadcrumb-Cp8rQom_.js";import{f as D,g as V,h as k,d as t,T as o,a as m,b as r,c as l,e as c,t as Y,i as W,j as G}from"./TimelineSeparator-j4hBT9mt.js";import"./DocumentationNavigation-GRGcrCKi.js";import"./ChangelogDoc-ngbKmtJS.js";const J=["className"],K=p=>{const{position:s,classes:d}=p,h={root:["root",D(s)]};return H(h,k,d)},Q=L(n,{name:"MuiTimelineOppositeContent",slot:"Root",overridesResolver:(p,s)=>{const{ownerState:d}=p;return[s.root,s[D(d.position)]]}})(({ownerState:p})=>x({padding:"6px 16px",marginRight:"auto",textAlign:"right",flex:1},p.position==="left"&&{textAlign:"left"})),R=g.forwardRef(function(s,d){const h=$({props:s,name:"MuiTimelineOppositeContent"}),{className:_}=h,E=z(h,J),{position:A}=g.useContext(V),I=x({},h,{position:A||"left"}),M=K(I);return u.jsx(Q,x({component:"div",className:B(M.root,_),ownerState:I,ref:d},E))});R.muiName="TimelineOppositeContent";const T=R;function X(){return i(c,{children:[i(t,{children:[i(o,{children:[e(m,{}),e(r,{})]}),e(l,{children:"Eat"})]}),i(t,{children:[i(o,{children:[e(m,{}),e(r,{})]}),e(l,{children:"Code"})]}),i(t,{children:[e(o,{children:e(m,{})}),e(l,{children:"Sleep"})]})]})}const Z=`import * as React from 'react';
...
`;function Re(){return i(c,{sx:{[`& .${Y.root}`]:{flex:.2}},children:[i(t,{children:[e(T,{color:"textSecondary",children:"09:30 am"}),i(o,{children:[e(m,{}),e(r,{})]}),e(l,{children:"Eat"})]}),i(t,{children:[e(T,{color:"textSecondary",children:"10:00 am"}),e(o,{children:e(m,{})}),e(l,{children:"Code"})]})]})}const Ne=`import * as React from 'react';
import Timeline from '@mui/lab/Timeline';
import TimelineItem from '@mui/lab/TimelineItem';
import TimelineSeparator from '@mui/lab/TimelineSeparator';
import TimelineConnector from '@mui/lab/TimelineConnector';
...
`;function je(){return i(c,{sx:{[`& .${G.root}:before`]:{flex:0,padding:0}},children:[i(t,{children:[i(o,{children:[e(m,{}),e(r,{})]}),e(l,{children:"Eat"})]}),i(t,{children:[e(o,{children:e(m,{})}),e(l,{children:"Code"})]})]})}const _e=`import * as React from 'react';
import Timeline from '@mui/lab/Timeline';
