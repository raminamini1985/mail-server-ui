import{s as L,T as n,bV as x,r as g,bX as $,bY as z,bZ as u,x as B,au as H,d as i,j as e,c9 as f,aS as C,F as P,C as F,b8 as q}from"./index-DTYAWF45.js";import{F as a}from"./FuseExample-BpkyGcBB.js";import{D as V}from"./DocumentationPageBreadcrumb-D4ISDkzL.js";import{f as D,g as U,h as Y,d as t,T as o,a as m,b as r,c as l,e as c,t as k,i as W,j as X}from"./TimelineSeparator-D2XbnvxM.js";import"./DocumentationNavigation-TV0mgQdh.js";import"./ChangelogDoc-CbVtVqTE.js";const Z=["className"],G=p=>{const{position:s,classes:d}=p,h={root:["root",D(s)]};return H(h,Y,d)},J=L(n,{name:"MuiTimelineOppositeContent",slot:"Root",overridesResolver:(p,s)=>{const{ownerState:d}=p;return[s.root,s[D(d.position)]]}})(({ownerState:p})=>x({padding:"6px 16px",marginRight:"auto",textAlign:"right",flex:1},p.position==="left"&&{textAlign:"left"})),R=g.forwardRef(function(s,d){const h=$({props:s,name:"MuiTimelineOppositeContent"}),{className:_}=h,E=z(h,Z),{position:A}=g.useContext(U),I=x({},h,{position:A||"left"}),M=G(I);return u.jsx(J,x({component:"div",className:B(M.root,_),ownerState:I,ref:d},E))});R.muiName="TimelineOppositeContent";const T=R;function K(){return i(c,{children:[i(t,{children:[i(o,{children:[e(m,{}),e(r,{})]}),e(l,{children:"Eat"})]}),i(t,{children:[i(o,{children:[e(m,{}),e(r,{})]}),e(l,{children:"Code"})]}),i(t,{children:[e(o,{children:e(m,{})}),e(l,{children:"Sleep"})]})]})}const Q=`import * as React from 'react';
