import{j as t,I as x,aq as o,d as i,o as n,B as f,s as d,d_ as p,r as m,T as e,cJ as v,c6 as y,h as w,d2 as u,aH as B}from"./index-DaquC3HQ.js";import{F as a}from"./FuseExample-aWT15uaH.js";import{D as A}from"./DocumentationPageBreadcrumb-Cp8rQom_.js";import{d as g}from"./Delete-TliRIqy0.js";import{G as s}from"./Grid-QBH5mSUX.js";import{Z as C}from"./Zoom-D9yhXZ0P.js";import"./DocumentationNavigation-GRGcrCKi.js";import"./ChangelogDoc-ngbKmtJS.js";function N(){return t(o,{title:"Delete",children:t(x,{children:t(g,{})})})}const R=`import * as React from 'react';
...
`;function P(){return t(o,{title:"Add",slotProps:{popper:{modifiers:[{name:"offset",options:{offset:[0,-14]}}]}},children:t(n,{children:"Offset"})})}const F=`import * as React from 'react';
import Button from '@mui/material/Button';
import Tooltip from '@mui/material/Tooltip';
...
`;function _(){return t(o,{title:"Add",disableInteractive:!0,children:t(n,{children:"Not interactive"})})}const X=`import * as React from 'react';
import Button from '@mui/material/Button';
import Tooltip from '@mui/material/Tooltip';
...
`;function J(){return t(o,{title:"You don't have permission to do this",children:t("span",{children:t(n,{disabled:!0,children:"A Disabled Button"})})})}const K=`import * as React from 'react';
import Button from '@mui/material/Button';
import Tooltip from '@mui/material/Tooltip';
...
`}),i(e,{className:"text-14 mb-32",component:"div",children:["the ",t("code",{children:"title"})," acts as an accessible description. If you want the tooltip to act as an accessible description you can pass ",t("code",{children:"describeChild"}),". Note that you shouldn't use ",t("code",{children:"describeChild"})," if the tooltip provides the only visual label. Otherwise, the child would have no accessible name and the tooltip would violate ",t("a",{href:"https://www.w3.org/WAI/WCAG21/Understanding/label-in-name.html",children:"success criterion 2.5.3 in WCAG 2.1"}),"."]}),t(e,{className:"text-14 mb-32",component:"div",children:t(a,{name:"AccessibilityTooltips.js",className:"my-16",iframe:!1,component:at,raw:st})})]})}export{bt as default};
