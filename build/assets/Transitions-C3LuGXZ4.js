import{r as c,d as n,j as e,l as d,bk as h,H as i,c5 as f,P as p,cL as I,cN as w,d9 as y,C as B,eq as N,e as T,z as R,h as L,g as P,F as G,T as o,dn as C,b8 as E}from"./index-DTYAWF45.js";import{F as m}from"./FuseExample-BpkyGcBB.js";import{D as O}from"./DocumentationPageBreadcrumb-D4ISDkzL.js";import{Z as k}from"./Zoom-DUH4_sYn.js";import{d as z}from"./Delete-CkqIddMo.js";import"./DocumentationNavigation-TV0mgQdh.js";import"./ChangelogDoc-CbVtVqTE.js";const x=e(p,{sx:{m:1,width:100,height:100},elevation:4,children:e("svg",{children:e(i,{component:"polygon",points:"0,100 50,00, 100,100",sx:{fill:t=>t.palette.common.white,stroke:t=>t.palette.divider,strokeWidth:1}})})});function j(){const[t,r]=c.useState(!1);return n(i,{sx:{height:300},children:[e(h,{control:e(d,{checked:t,onChange:()=>{r(a=>!a)}}),label:"Show"}),n(i,{sx:{"& > :not(style)":{display:"flex",justifyContent:"space-around",height:120,width:250}},children:[n("div",{children:[e(f,{in:t,children:x}),e(f,{in:t,collapsedSize:40,children:x})]}),n("div",{children:[e(i,{sx:{width:"50%"},children:e(f,{orientation:"horizontal",in:t,children:x})}),e(i,{sx:{width:"50%"},children:e(f,{orientation:"horizontal",in:t,collapsedSize:40,children:x})})]})]})]})}const D=`import * as React from 'react';
...
`,v=["🍏 Apple","🍌 Banana","🍍 Pineapple","🥥 Coconut","🍉 Watermelon"];function V({item:t,handleRemoveFruit:r}){return e(P,{secondaryAction:e(R,{edge:"end","aria-label":"delete",title:"Delete",onClick:()=>r(t),children:e(z,{})}),children:e(L,{primary:t})})}function X(){const[t,r]=c.useState(v.slice(0,3)),l=()=>{const s=v.find(u=>!t.includes(u));s&&r(u=>[s,...u])},a=s=>{r(u=>[...u.filter(F=>F!==s)])},g=e(B,{variant:"contained",disabled:t.length>=v.length,onClick:l,children:"Add fruit to basket"});return n("div",{children:[g,e(T,{sx:{mt:1},children:e(N,{children:t.map(s=>e(f,{children:V({item:s,handleRemoveFruit:a})},s))})})]})}const ee=`import * as React from 'react';
...
`}),e(o,{className:"text-14 mb-32",component:"div",children:"As with any performance optimization this is not a silver bullet. Be sure to identify bottlenecks first and then try out these optimization strategies."})]})}export{ce as default};
